...
class MyAvailabilityView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<MyAvailabilityViewModel>.reactive(
    ...
    return Column(
      children: [
        ...
        model.isBusy
            ...
            : Expanded(
                child: model.jobBookings.length > 0
                    ? ListView.separated(
                        padding: AppBaseStyles.horizontalPadding
                            .copyWith(bottom: 16, top: 16),
                        itemBuilder: (_, index) {
                          final request = model.jobBookings[index];
                    ...
                    arguments: PetDetailsViewArguments(
                      ...
                      role: Roles.petSitter,
                        ...
                        itemCount: model.jobBookings.length,
                      )
