...
class NotificationsViewModel extends BaseViewModel {
  ...
  get isNotificationLoading {
    return this.loading['notification'];
  }
  ...
  Future<List<Map<String, dynamic>>?> getNotifications() async {
    ...
    ApiResult<dynamic> apiResult = await _apiService.getNotifications();
    apiResult.when(success: (data) {
      notifications = data;
      print('notifications===>');
      print(notifications);
      setLoading('notification', false);
      setBusy(false);
  ...
  set notifications(List<Map<String, dynamic>> val) {
    _notifications = val;
    notifyListeners();
  }
